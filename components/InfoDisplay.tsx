...
const InfoDisplay: React.FC<InfoDisplayProps> = ({ isVisible, onClose }) => {
  ...
  return (
    <div aria-labelledby="info-title" aria-modal="true" className={`animated-frame ${isVisible ? 'open' : ''}`} role="dialog">
      <div className="animated-frame-content">
        ...
        <div className="info-content-area">
          <h1 className="text-3xl font-bold text-sky-300 mb-6 text-center" id="info-title">

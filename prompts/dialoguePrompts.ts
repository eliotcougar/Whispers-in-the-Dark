...
Respond ONLY in JSON format with the following structure:
{
  ...
  "charactersAdded"?: [ /* { "name", "description", "aliases", "presenceStatus": ${VALID_PRESENCE_STATUS_VALUES_STRING}, "lastKnownLocation": "...", "preciseLocation": "..." } if new characters were *introduced or became significant*. */ ],
  "charactersUpdated"?: [ /* { "name", "newDescription", "newAliases", "addAlias", "newPresenceStatus": ${VALID_PRESENCE_STATUS_VALUES_STRING}, "newLastKnownLocation": "...", "newPreciseLocation": "..." } if dialogue provided new information about existing characters or their presence state. */ ],
...
Items:
If the dialogue resulted in obtaining or losing any Items, including the 'knowledge'-type Items and "status effects", use "itemChange" actions "gain", "lose", or "update".
${ITEMS_GUIDE}

...
Respond ONLY in JSON format with the following structure:
{
  ...
  "mapHint"?: string /* Optional short hint for the Map AI about distant quest-related locations and how to reach them from the current location. */
}
...
- If new distant quest-related locations are mentioned but not yet visited, provide a short description of them and how to reach them in "mapHint" for the Map AI.

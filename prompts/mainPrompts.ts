...
Respond ONLY in JSON format with the following structure:
{
  ...
  "itemChange"?: [ /* Optional array. Send an empty array e.g., "itemChange": [], or omit if no items are affected. Each object in the array must follow the structure defined in ITEMS_GUIDE for its respective itemChange action. Supports actions 'gain', 'lose', 'update', 'put', and 'give'. */
    ... ],
